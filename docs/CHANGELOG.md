...
- Expanded the GearColeco overlay self-test to 23 runtime assertions, covering record stride, mixed scalar types, qualified mutations and loops, plus VRAM reads into qualified primitive array fields in all five optimization profiles.
