...
- `REM` comments work on full lines and after code
...
- `nmi on/off` does not yet let source code register a custom per-frame user NMI subroutine
- this is a plausible future runtime feature for AMY, especially because older Coleco lib4k/lib4ksa-style environments exposed NMI-adjacent extension points and wrapper patterns for project code
