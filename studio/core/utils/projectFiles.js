...
export function assetNameFromProjectPath(path) {
  ...
  const withoutCodec = base.replace(/\.(zx0|zx7|aplib|dan1|dan2|dan3|pletter|plet5|lzf|rle|mdkrle|bitbuster|nibble)$/i, "");
...
export function fileKindFromPath(path) {
  ...
  if (/\.(sprpat|sprcolor|sprattr)(?:\.(zx0|zx7|aplib|dan1|dan2|dan3|pletter|plet5|lzf|rle|mdkrle|bitbuster|nibble))?$/.test(lower)) return "sprite";
  if (/\.(pc|pattern|pat|chr|color|col|clr|name|nam)(?:\.(zx0|zx7|aplib|dan1|dan2|dan3|pletter|plet5|lzf|rle|mdkrle|bitbuster|nibble))?$/.test(lower)) return "picture";
  if (/\.(zx0|zx7|aplib|dan1|dan2|dan3|pletter|plet5|lzf|rle|mdkrle|bitbuster|nibble)$/.test(lower)) return "compressed";
