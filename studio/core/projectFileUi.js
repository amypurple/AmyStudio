...
export function createProjectFileUiHelpers({
  ...
  const CODEC_Z80_RUNTIME = {
    ...
    exomizer: { rank: 4, label: "table-driven LZ VRAM back-copy", note: "Uses a conditional 156-byte RAM table." },
  ...
  const tileTableCompressionOptions = [
    ...
    { codec: "exomizer", label: "Exomizer P0", description: "Strong compression with a direct-VRAM routine and conditional work table.", routineBytes: 226, extension: "exo" },
