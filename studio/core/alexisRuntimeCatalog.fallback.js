...
export const alexisRuntimeCatalog = {
  ...
  "AMY_SET_GRAPHICS_MODE1_TEXT": {
    ...
    "asm": "AMY_SET_GRAPHICS_MODE1_TEXT:\n    ld bc,$0000\n    call WRITE_REGISTER\n    ld bc,$0182\n    call WRITE_REGISTER\n    ld a,$82\n    ld ($73C4),a\n    ld bc,$0380\n    call WRITE_REGISTER\n    ld bc,$0400\n    call WRITE_REGISTER\n    ld bc,$0536\n    call WRITE_REGISTER\n    ld bc,$0607\n    call WRITE_REGISTER\n    ld hl,VRAM_NAME\n    call AMY_SET_DEFAULT_NAME_TABLE\n    ld de,$0300\n    ld a,$20\n    jp FILL_VRAM\n\n; Configure multicolor mode (Mode 3) and initialize the name table with the\n; historical $00..$FF sequence repeated three times.\n; Display stays blanked until screen on/display on is called."
  },
  ...
  "AMY_SET_DEFAULT_NAME_TABLE": {
    "group": "vdp",
    "sourcePath": "src/alexis_lib/coleco_vdp.asm",
    "asm": "AMY_SET_DEFAULT_NAME_TABLE:\n    push hl\n    push ix\n    push iy\n    ld a,2\n    call INIT_TABLE\n    pop iy\n    pop ix\n    pop hl\n    ld ($73F6),hl\n    ret\n\n; Copy BC bytes from HL into VRAM destination DE using the BIOS primitive.\n; This is the ALEXIS-native equivalent of lib4ksa _put_vram."
  },
  "AMY_COPY_BYTES_TO_VRAM": {
    ...
    "asm": "; Copy BC bytes from ROM/RAM at HL to VRAM address DE.\nAMY_COPY_BYTES_TO_VRAM:\n    ld a,e\n    out (VDP_CTRL_PORT),a\n    ld a,d\n    or $40\n    out (VDP_CTRL_PORT),a\nAMY_COPY_BYTES_TO_VRAM_LOOP:\n    ld a,b\n    or c\n    ret z\n    ld a,(hl)\n    out (VDP_DATA_PORT),a\n    nop\n    inc hl\n    dec bc\n    jr AMY_COPY_BYTES_TO_VRAM_LOOP"
  },
  "AMY_VPOKE": {
    "group": "vdp",
    "sourcePath": "src/alexis_lib/coleco_vdp.asm",
    "asm": "; Write one byte to VRAM. Input: HL=VRAM address, A=value.\nAMY_VPOKE:\n    ld e,a\n    ld a,l\n    out (VDP_CTRL_PORT),a\n    ld a,h\n    or $40\n    out (VDP_CTRL_PORT),a\n    ld a,e\n    out (VDP_DATA_PORT),a\n    nop\n    ret"
  },
  "AMY_VPEEK": {
    "group": "vdp",
    "sourcePath": "src/alexis_lib/coleco_vdp.asm",
    "asm": "; Read one byte from VRAM. Input: HL=VRAM address. Output: A=value.\nAMY_VPEEK:\n    ld a,l\n    out (VDP_CTRL_PORT),a\n    ld a,h\n    and $3F\n    out (VDP_CTRL_PORT),a\n    ex (sp),hl\n    ex (sp),hl\n    in a,(VDP_DATA_PORT)\n    ret"
  },
  "AMY_MODE2_CALC_ADDRESS_MASK": {
    "group": "vdp",
    "sourcePath": "src/alexis_lib/coleco_vdp.asm",
    "asm": "; Input: B=x, C=y. Output: HL=pattern byte address, A=bit mask for that pixel.\nAMY_MODE2_CALC_ADDRESS_MASK:\n    ld a,c\n    and 7\n    ld e,a\n    ld a,b\n    and $F8\n    add a,e\n    ld e,a\n    ld a,c\n    srl a\n    srl a\n    srl a\n    ld d,a\n    ld a,b\n    and 7\n    ld l,a\n    ld h,0\n    ld bc,AMY_MODE2_BIT_TABLE\n    add hl,bc\n    ld a,(hl)\n    ex de,hl\n    ret\nAMY_MODE2_BIT_TABLE:\n    db $80,$40,$20,$10,$08,$04,$02,$01"
  },
  "AMY_MODE2_PSET": {
    "group": "vdp",
    "sourcePath": "src/alexis_lib/coleco_vdp.asm",
    ...
    "asm": "; Input: B=x, C=y. Sets one pixel in the Mode 1 bitmap surface.\nAMY_MODE2_PSET:\n    ld a,c\n    cp 192\n    ret nc\n    call AMY_MODE2_CALC_ADDRESS_MASK\n    ld b,a\n    push bc\n    push hl\n    call AMY_VPEEK\n    pop hl\n    pop bc\n    or b\n    jp AMY_VPOKE"
  },
  "AMY_MODE2_PRESET": {
    "group": "vdp",
    "sourcePath": "src/alexis_lib/coleco_vdp.asm",
    ...
    "asm": "; Input: B=x, C=y. Clears one pixel in the Mode 1 bitmap surface.\nAMY_MODE2_PRESET:\n    ld a,c\n    cp 192\n    ret nc\n    call AMY_MODE2_CALC_ADDRESS_MASK\n    cpl\n    ld b,a\n    push bc\n    push hl\n    call AMY_VPEEK\n    pop hl\n    pop bc\n    and b\n    jp AMY_VPOKE"
  },
  "AMY_MODE2_PSET_COLOR": {
    ...
    "asm": "; Input: A=color nibble, B=x, C=y. Sets one pixel and writes a row color byte.\nAMY_MODE2_PSET_COLOR:\n    push af\n    ld a,c\n    cp 192\n    jr c,AMY_MODE2_PSET_COLOR_INRANGE\n    pop af\n    ret\nAMY_MODE2_PSET_COLOR_INRANGE:\n    call AMY_MODE2_CALC_ADDRESS_MASK\n    ld b,a\n    push bc\n    push hl\n    call AMY_VPEEK\n    pop hl\n    pop bc\n    or b\n    call AMY_VPOKE\n    ld a,h\n    add a,$20\n    ld h,a\n    pop af\n    and $0F\n    add a,a\n    add a,a\n    add a,a\n    add a,a\n    jp AMY_VPOKE"
  },
  ...
  "AMY_MODE2_PLOT_CLIP": {
    ...
    "asm": "; Input: HL = signed X, DE = signed Y. Plot only if on-screen.\nAMY_MODE2_PLOT_CLIP:\n    ld a,h\n    or a\n    ret nz\n    ld a,d\n    or a\n    ret nz\n    ld a,e\n    cp 192\n    ret nc\n    ld b,l\n    ld c,e\n    jp AMY_MODE2_PSET"
  },
  ...
  "AMY_MODE2_LINE_COLOR": {
    ...
    "asm": "; Input: A=color nibble, B=x1, C=y1, D=x2, E=y2.\nAMY_MODE2_LINE_COLOR:\n    ld (AMY_MODE2_COLOR),a\n    ld a,1\n    ld (AMY_MODE2_USECOLOR),a\n    jp AMY_MODE2_LINE_CORE"
  },
  ...
  "AMY_MODE2_CIRCLE": {
    ...
    "asm": "; Input: B=centerX, C=centerY, D=radius.\nAMY_MODE2_CIRCLE:\n    xor a\n    ld (AMY_MODE2_USECOLOR),a\n    jp AMY_MODE2_CIRCLE_CORE"
  },
  "AMY_MODE2_CIRCLE_COLOR": {
    ...
    "asm": "; Input: A=color nibble, B=centerX, C=centerY, D=radius.\nAMY_MODE2_CIRCLE_COLOR:\n    ld (AMY_MODE2_COLOR),a\n    ld a,1\n    ld (AMY_MODE2_USECOLOR),a\n    jp AMY_MODE2_CIRCLE_CORE"
  },
  "AMY_PUT_VRAM": {
    "group": "vdp",
    "sourcePath": "src/alexis_lib/coleco_vdp.asm",
  ...
  "AMY_SET_SCREEN_PAGES": {
    ...
    "asm": "; Select viewed HL and edit DE name tables for double-buffered text screens.\nAMY_SET_SCREEN_PAGES:\n    push de\n    ld bc,AMY_SCREEN_VIEW_POINTER\n    ld a,l\n    ld (bc),a\n    inc bc\n    ld a,h\n    ld (bc),a\n    push ix\n    push iy\n    ld a,2\n    call INIT_TABLE\n    pop iy\n    pop ix\n    pop de\n    ld ($73F6),de\n    ret"
  },
  "AMY_SWAP_SCREEN_PAGES": {
    ...
    "asm": "; Swap the viewed and edit name tables configured by AMY_SET_SCREEN_PAGES.\nAMY_SWAP_SCREEN_PAGES:\n    ld de,(AMY_SCREEN_VIEW_POINTER)\n    ld hl,($73F6)\n    jp AMY_SET_SCREEN_PAGES"
  },
  ...
  "AMY_DISABLE_NMI": {
    ...
    "asm": "; Match lib4ksa disable_nmi: clear the VDP interrupt-enable bit in R1.\nAMY_DISABLE_NMI:\n    ld a,($73C4)\n    and $DF\n    ld ($73C4),a\n    ld c,a\n    ld b,1\n    call WRITE_REGISTER\n    ret"
  },
  "AMY_SCREEN_ON_NMI": {
    "group": "vdp",
    "sourcePath": "src/alexis_lib/coleco_vdp.asm",
  ...
  "AMY_ENABLE_NMI": {
    "group": "vdp",
    "sourcePath": "src/vendor/cvdevkit_sdcc/lib4ksa",
    "asm": "; Match lib4ksa enable_nmi: set the VDP interrupt-enable bit in R1 and acknowledge status.\nAMY_ENABLE_NMI:\n    ld a,($73C4)\n    or $20\n    ld ($73C4),a\n    ld c,a\n    ld b,1\n    call WRITE_REGISTER\n    call READ_REGISTER\n    ret"
  },
  "AMY_SET_SPRITES8X8": {
    "group": "sprites",
  ...
  "AMY_SET_SPRITE": {
    "group": "sprites",
    "sourcePath": "src/alexis_lib/coleco_sprite.asm",
    "asm": "; Store one sprite entry in the shadow table. Input: A=index, B=y, C=x, D=pattern, E=color.\nAMY_SET_SPRITE:\n    push de\n    add a,a\n    add a,a\n    ld l,a\n    ld h,0\n    ld de,AMY_SPRITE_TABLE\n    add hl,de\n    ld (hl),b\n    inc hl\n    ld (hl),c\n    inc hl\n    pop de\n    ld (hl),d\n    inc hl\n    ld (hl),e\n    ret"
  },
  "AMY_HIDE_SPRITE": {
    "group": "sprites",
    "sourcePath": "src/alexis_lib/coleco_sprite.asm",
    "asm": "; Hide one sprite entry by setting Y to $CF. Input: A=index.\nAMY_HIDE_SPRITE:\n    add a,a\n    add a,a\n    ld l,a\n    ld h,0\n    ld de,AMY_SPRITE_TABLE\n    add hl,de\n    ld (hl),$CF\n    ret"
  },
  "AMY_CLEAR_SPRITES": {
    "group": "sprites",
    "sourcePath": "src/alexis_lib/coleco_sprite.asm",
  ...
  "AMY_ENABLE_SPINNER": {
    ...
    "asm": "; Enable lib4ksa-compatible spinner interrupts.\nAMY_ENABLE_SPINNER:\n    push af\n    ei\n    or $FF\n    ld hl,SPINNER_ENABLED\n    ld (hl),a\n    pop af\n    ret"
  },
  "AMY_DISABLE_SPINNER": {
    "group": "spinner",
    "sourcePath": "src/vendor/cvdevkit_sdcc/lib4ksa/spinner.s",
    "asm": "; Disable lib4ksa-compatible spinner interrupts.\nAMY_DISABLE_SPINNER:\n    push af\n    di\n    xor a\n    ld hl,SPINNER_ENABLED\n    ld (hl),a\n    pop af\n    ret"
  },
  "AMY_RESET_SPINNER1": {
    "group": "spinner",
    "sourcePath": "src/vendor/cvdevkit_sdcc/lib4ksa/spinner.s",
  ...
  "AMY_PLAY_SOUND": {
    ...
    "asm": "AMY_PLAY_SOUND:\n    push ix\n    push iy\n    call PLAY_SOUND_SLOT\n    pop iy\n    pop ix\n    ret\n\n; Terminate a single sound slot. Input: B = sound index (1-based)."
  },
  "AMY_STOP_SOUND": {
    "group": "sound",
    "sourcePath": "src/alexis_lib/coleco_sound.asm",
  ...
  "AMY_WIPE_SCREEN_UP": {
    "group": "text",
    "sourcePath": "src/alexis_lib/coleco_text.asm",
    "asm": "; Blank name table rows bottom-to-top, one row per frame (24 frames total).\nAMY_WIPE_SCREEN_UP:\n    ld hl,($73F6)\n    ld de,$02E0\n    add hl,de\n    ld b,24\nAMY_WIPE_SCREEN_UP_ROW:\n    push bc\n    push hl\n    halt\n    pop hl\n    push hl\n    ld de,32\n    ld a,$20\n    call FILL_VRAM\n    pop hl\n    ld de,$FFE0\n    add hl,de\n    pop bc\n    djnz AMY_WIPE_SCREEN_UP_ROW\n    ret"
  },
  "AMY_WIPE_SCREEN_DOWN": {
    "group": "text",
    "sourcePath": "src/alexis_lib/coleco_text.asm",
    "asm": "; Blank name table rows top-to-bottom, one row per frame (24 frames total).\nAMY_WIPE_SCREEN_DOWN:\n    ld hl,($73F6)\n    ld b,24\nAMY_WIPE_SCREEN_DOWN_ROW:\n    push bc\n    push hl\n    halt\n    pop hl\n    push hl\n    ld de,32\n    ld a,$20\n    call FILL_VRAM\n    pop hl\n    ld de,32\n    add hl,de\n    pop bc\n    djnz AMY_WIPE_SCREEN_DOWN_ROW\n    ret"
  },
  "AMY_WIPE_BITMAP_UP": {
    "group": "graphics",
  ...
  "AMY_PUT_AT": {
    ...
    "asm": "; Copy B bytes from HL to the name table at D=y, E=x.\nAMY_PUT_AT:\n    ld a,b\n    or a\n    ret z\n    push hl\n    call AMY_TEXT_CALC_NAME_ADDRESS\n    ld a,l\n    out (VDP_CTRL_PORT),a\n    ld a,h\n    or $40\n    out (VDP_CTRL_PORT),a\n    pop hl\nAMY_PUT_AT_LOOP:\n    ld a,(hl)\n    out (VDP_DATA_PORT),a\n    inc hl\n    djnz AMY_PUT_AT_LOOP\n    ret"
  },
  "AMY_PRINT_FP5_AT": {
    "group": "text",
    "sourcePath": "src/alexis_lib/coleco_text.asm",
  ...
  "AMY_MODE3_CALC_COLOR_ADDRESS": {
    ...
    "asm": "AMY_MODE3_CALC_COLOR_ADDRESS:\n    ; Calculate the Mode 3 pattern byte address for X/Y.\n    ; Input: B = x, C = y. Output: HL = VRAM pattern byte address.\n    ld a,c\n    and 7\n    ld l,a\n    ld a,c\n    sub l\n    rrca\n    rrca\n    rrca\n    ld h,a\n    ld a,b\n    and $3E\n    add a,a\n    add a,a\n    add a,l\n    ld l,a\n    ret",
    "extractedFromSource": true,
