...
export const alexisRuntimeCatalog = {
  ...
  "AMY_LOAD_MODE2_TEXT_COLORS_32": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_vdp_modes.asm",
    "extractedFromLabel": "AMY_LOAD_MODE2_TEXT_COLORS_32"
  },
  ...
  "AMY_SPRITE_FLICKER_ON": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_sprite_table.asm",
    "extractedFromLabel": "AMY_SPRITE_FLICKER_ON"
  },
  "AMY_SPRITE_FLICKER_OFF": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_sprite_table.asm",
    "extractedFromLabel": "AMY_SPRITE_FLICKER_OFF"
  },
  "AMY_UPDATE_SPRITES_FLICKER": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_sprite_table.asm",
    "extractedFromLabel": "AMY_UPDATE_SPRITES_FLICKER"
  },
  ...
  "AMY_VOICE_DETECT": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_DETECT"
  },
  "AMY_VOICE_READY": {
    "group": "voice",
    "sourcePath": "src/alexis_lib/coleco_voice.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_READY"
  },
  "AMY_VOICE_RESET": {
    "group": "voice",
    "sourcePath": "src/alexis_lib/coleco_voice.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_RESET"
  },
  "AMY_VOICE_ALLOPHONE": {
    "group": "voice",
    "sourcePath": "src/alexis_lib/coleco_voice.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_ALLOPHONE"
  },
  "AMY_VOICE_SPEAK": {
    "group": "voice",
    "sourcePath": "src/alexis_lib/coleco_voice.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_SPEAK"
  },
  "AMY_VOICE_START": {
    "group": "voice",
    "sourcePath": "src/alexis_lib/coleco_voice.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_START"
  },
  "AMY_VOICE_UPDATE": {
    "group": "voice",
    "sourcePath": "src/alexis_lib/coleco_voice.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_UPDATE"
  },
  "AMY_VOICE_STOP": {
    "group": "voice",
    "sourcePath": "src/alexis_lib/coleco_voice.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_STOP"
  },
  "AMY_VOICE_SPEAKING": {
    "group": "voice",
    "sourcePath": "src/alexis_lib/coleco_voice.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_voice.asm",
    "extractedFromLabel": "AMY_VOICE_SPEAKING"
  },
  "AMY_PSG_TONE": {
    "group": "sound",
    "sourcePath": "src/alexis_lib/coleco_psg.asm",
    "asm": "AMY_PSG_TONE:\n    ld a,b\n    and $03\n    add a,a\n    add a,a\n    add a,a\n    add a,a\n    add a,a\n    or $80\n    ld b,a\n    ld a,l\n    and $0F\n    or b\n    out ($FF),a\n    add hl,hl\n    add hl,hl\n    add hl,hl\n    add hl,hl\n    ld a,h\n    and $3F\n    out ($FF),a\n    ret\n\n; B=channel 0..3, C=attenuation 0..15 (0 loudest, 15 silent).",
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_psg.asm",
    "extractedFromLabel": "AMY_PSG_TONE"
  },
  "AMY_PSG_VOLUME": {
    "group": "sound",
    "sourcePath": "src/alexis_lib/coleco_psg.asm",
    "asm": "AMY_PSG_VOLUME:\n    ld a,b\n    and $03\n    add a,a\n    add a,a\n    add a,a\n    add a,a\n    add a,a\n    or $90\n    ld b,a\n    ld a,c\n    and $0F\n    or b\n    out ($FF),a\n    ret\n\n; B=mode (0 periodic, nonzero white), C=rate 0..3.",
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_psg.asm",
    "extractedFromLabel": "AMY_PSG_VOLUME"
  },
  "AMY_PSG_NOISE": {
    "group": "sound",
    "sourcePath": "src/alexis_lib/coleco_psg.asm",
    "asm": "AMY_PSG_NOISE:\n    ld a,b\n    or a\n    ld a,$E0\n    jr z,AMY_PSG_NOISE_RATE\n    or $04\nAMY_PSG_NOISE_RATE:\n    ld b,a\n    ld a,c\n    and $03\n    or b\n    out ($FF),a\n    ret",
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_psg.asm",
    "extractedFromLabel": "AMY_PSG_NOISE"
  },
  ...
  "AMY_U8_TO_ASCII2_MOD": {
    ...
    "asm": "AMY_U8_TO_ASCII2_MOD:\n    cp 100\n    jr c,AMY_U8_TO_ASCII2_MOD_READY\n    sub 100\n    jr AMY_U8_TO_ASCII2_MOD\nAMY_U8_TO_ASCII2_MOD_READY:\n    jp AMY_U8_TO_ASCII2",
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_math_format_u8_2_mod.asm",
    "extractedFromLabel": "AMY_U8_TO_ASCII2_MOD"
  },
  "AMY_PAUSE_PRESS_RELEASE_BLANK": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_pause.asm",
    "extractedFromLabel": "AMY_PAUSE_PRESS_RELEASE_BLANK"
  },
  "AMY_CHOICE_KEYPAD_RANGE_BLANK": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_pause.asm",
    "extractedFromLabel": "AMY_CHOICE_KEYPAD_RANGE_BLANK"
  },
  "AMY_120C_ON": {
    "group": "display",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_120c.asm",
    "extractedFromLabel": "AMY_120C_ON"
  },
  "AMY_120C_OFF": {
    "group": "display",
    "sourcePath": "src/alexis_lib/coleco_120c.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_120c.asm",
    "extractedFromLabel": "AMY_120C_OFF"
  },
  "AMY_120C_UPDATE": {
    "group": "display",
    "sourcePath": "src/alexis_lib/coleco_120c.asm",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_120c.asm",
    "extractedFromLabel": "AMY_120C_UPDATE"
  },
  "AMY_PLAY_TRIPCM": {
    "group": "sound",
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_tripcm.asm",
    "extractedFromLabel": "AMY_PLAY_TRIPCM"
  },
  "AMY_PLAY_TRIPCM_COMPACT": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_tripcm_compact.asm",
    "extractedFromLabel": "AMY_PLAY_TRIPCM_COMPACT"
  },
  "AMY_PLAY_TRIPCM_SEQUENCE": {
    ...
    "extractedFromSource": true,
    "extractedFromPath": "src/alexis_lib/coleco_tripcm_sequence.asm",
    "extractedFromLabel": "AMY_PLAY_TRIPCM_SEQUENCE"
  }
};
