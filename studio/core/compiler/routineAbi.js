...
export const ROUTINE_ABI = Object.freeze({
  ...
  AMY_FX8_8_MUL: abi({ inputs: { hl: "left", de: "right" }, outputs: { hl: "result" }, clobbers: ["af", "bc", "de", "hl"] }),
  AMY_UFX8_8_MUL: abi({ inputs: { hl: "left", de: "right" }, outputs: { hl: "result" }, clobbers: ["af", "bc", "de", "hl"] }),
  AMY_FX8_8_DIV: abi({ inputs: { hl: "left", de: "right" }, outputs: { hl: "result" }, clobbers: ["af", "bc", "de", "hl"] }),
  AMY_UFX8_8_DIV: abi({ inputs: { hl: "left", de: "right" }, outputs: { hl: "result" }, clobbers: ["af", "bc", "de", "hl"] }),
  ...
  AMY_VOICE_DETECT: abi({ clobbers: ["af", "bc", "de"] }),
  AMY_VOICE_READY: abi({ clobbers: ["af"] }),
  AMY_VOICE_RESET: abi({ clobbers: ["af", "de"] }),
  AMY_VOICE_ALLOPHONE: abi({ clobbers: ["af"] }),
  AMY_VOICE_SPEAK: abi({ clobbers: ["af", "bc", "hl"] }),
  AMY_VOICE_START: abi({ clobbers: ["af"] }),
  AMY_VOICE_UPDATE: abi({ clobbers: ["af", "bc", "hl"] }),
  AMY_VOICE_STOP: abi({ clobbers: ["af"] }),
  AMY_VOICE_SPEAKING: abi({ clobbers: ["af", "hl"] }),
  AMY_PSG_TONE: abi({ clobbers: ["af", "b", "hl"] }),
  AMY_PSG_VOLUME: abi({ clobbers: ["af", "b"] }),
  AMY_PSG_NOISE: abi({ clobbers: ["af", "b"] }),
