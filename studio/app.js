...
import { createRomTestRecorderUi } from "./core/romTestRecorderUi.js?v=20260825-scene-poison-diagnostics";
...
import { createProjectFileUiHelpers } from "./core/projectFileUi.js?v=20260907-sound-workflow-context";
...
function syncExampleIndexFromModule(examples, { force = false } = {}) {
  ...
  if (Array.isArray(examples.exampleManifest)) {
