...
const tests = [
  ...
  { file: "test-play-sounds-codegen.mjs", area: "multi-sound-playback", evidence: "compile+assemble", suite: "audio" },
  { file: "test-dsound-nmi-codegen.mjs", area: "dsound-nmi-protection", evidence: "compile+assemble", suite: "audio" },
  ...
  { file: "test-autocomplete-preference.mjs", area: "autocomplete-preference", evidence: "unit", suite: "studio" },
  { file: "test-example-assets-lazy.mjs", area: "lazy-example-assets", evidence: "unit", suite: "studio" },
  { file: "test-public-portal.mjs", area: "public-portal", evidence: "unit", suite: "studio" },
  { file: "test-rom-debug-drag-drop.mjs", area: "external-rom-drag-drop", evidence: "unit", suite: "studio" },
  { file: "test-rom-debug-external-hardware-ui.mjs", area: "external-hardware-debug-ui", evidence: "unit", suite: "studio" },
  { file: "test-graphics-editor-builder.mjs", area: "graphics-editor-builder", evidence: "unit", suite: "graphics" },
  { file: "test-benchmark-graphics-editors.mjs", area: "graphics-editor-benchmark", evidence: "benchmark", suite: "graphics" },
  { file: "test-aplib-vram-rom.mjs", area: "aplib-vram", evidence: "rom", suite: "codecs" },
  { file: "test-integrated-codec-vram-roms.mjs", area: "integrated-codec-vram", evidence: "rom", suite: "codecs" },
  { file: "test-zx1-codec.mjs", area: "zx1-codec", evidence: "unit", suite: "codecs" },
  { file: "test-zx1-picture-corpus.mjs", area: "zx1-picture-corpus", evidence: "unit", suite: "codecs" },
  { file: "test-zx1-vram-rom.mjs", area: "zx1-vram", evidence: "rom", suite: "codecs" },
  { file: "test-zx2-codec.mjs", area: "zx2-codec", evidence: "unit", suite: "codecs" },
  { file: "test-zx2-vram-rom.mjs", area: "zx2-vram", evidence: "rom", suite: "codecs" },
  { file: "test-coleco-midi-input.mjs", area: "midi-input", evidence: "unit", suite: "audio" },
  { file: "test-coleco-music-song.mjs", area: "music-song", evidence: "unit", suite: "audio" },
  { file: "test-coleco-sound-table-builder.mjs", area: "sound-table-builder", evidence: "unit", suite: "audio" },
  ...
  { file: "test-wav-spectral-noise-roundtrip-rom.mjs", area: "wav-noise-roundtrip", evidence: "rom", suite: "audio" },
  { file: "test-wav-spectral-sfx-rom.mjs", area: "wav-spectral-sfx", evidence: "rom", suite: "audio" },
  { file: "test-wav-spectral-tone-modes-rom.mjs", area: "wav-tone-modes", evidence: "rom", suite: "audio" },
  { file: "test-earth-globe-demo.mjs", area: "earth-globe-demo", evidence: "rom", suite: "examples" },
  { file: "test-solar-system-encyclopedia.mjs", area: "solar-system-encyclopedia", evidence: "rom", suite: "examples" },
  { file: "test-code-data-boundary.mjs", area: "code-data-boundary", evidence: "compile+assemble" },
  { file: "test-compare-1-codegen.mjs", area: "compare-one-codegen", evidence: "compile+assemble" },
  { file: "test-compare-255-codegen.mjs", area: "compare-255-codegen", evidence: "compile+assemble" },
  { file: "test-cvbasic-plot-port-rom.mjs", area: "cvbasic-plot-port", evidence: "rom" },
  { file: "test-keypad-idle-contract.mjs", area: "keypad-idle-contract", evidence: "compile+assemble" },
  { file: "test-metasprite-data-prototype.mjs", area: "metasprite-data", evidence: "rom" },
  { file: "test-bcd-removed-forms.mjs", area: "removed-bcd-forms", evidence: "diagnostics" },
  { file: "test-graphics-mode-removed-forms.mjs", area: "removed-graphics-mode-forms", evidence: "diagnostics" },
  { file: "test-min-max-removed-forms.mjs", area: "removed-min-max-forms", evidence: "diagnostics" },
  { file: "test-on-frame-top-level-removed.mjs", area: "removed-top-level-on-frame", evidence: "diagnostics" },
  { file: "test-rem-removed-form.mjs", area: "removed-rem-form", evidence: "diagnostics" },
  { file: "test-typed-print-format-removed.mjs", area: "removed-typed-print-format", evidence: "diagnostics" },
  { file: "test-u32-removed-forms.mjs", area: "removed-u32-forms", evidence: "diagnostics" },
  { file: "test-vram-fill-removed-form.mjs", area: "removed-vram-fill-form", evidence: "diagnostics" },
  { file: "test-vram-removed-forms.mjs", area: "removed-vram-forms", evidence: "diagnostics" },
  { file: "test-wait-removed-forms.mjs", area: "removed-wait-forms", evidence: "diagnostics" },
  ...
  { file: "test-display-cost-benchmark.mjs", area: "display-cost-benchmark", evidence: "rom", suite: "examples" },
...
if (suite && !["language", "studio", "graphics", "emulator", "codecs", "audio", "examples"].includes(suite)) {
