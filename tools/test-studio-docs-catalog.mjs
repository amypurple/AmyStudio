...
assert.ok(paths.length >= 10, `Expected the public Studio Docs workflows, got ${paths.length}.`);
...
for (const relativePath of ["studio-workflow.md", "rom-runtime-testing.md", "amy-optimization-cookbook.md"]) {
...
for (const required of [
  "amy-current-version.md", "studio-workflow.md", "rom-runtime-testing.md",
